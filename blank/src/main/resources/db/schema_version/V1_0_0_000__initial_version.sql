...
CREATE TABLE IF NOT EXISTS Pertenecian (
  id int(3) NOT NULL AUTO_INCREMENT,
  Libro int(3) NOT NULL,
  Categoria int(2) NOT NULL,
  PRIMARY KEY (id),
  UNIQUE INDEX (id),
  CONSTRAINT FKPertenecian111111 FOREIGN KEY (Libro) REFERENCES Eliminados (id),
  CONSTRAINT FKPertenecian999999 FOREIGN KEY (Categoria) REFERENCES Categorias (id)
) ENGINE=INNODB DEFAULT CHARSET=utf8;